const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ContentPages-DybwahIv.js","assets/vendor-helmet-BPZdwhdD.js","assets/vendor-react-D2C-z3V_.js","assets/vendor-icons-DAaO-fqo.js","assets/content-articles-Dn4oaumy.js","assets/DetailPages-DFuEd0wG.js","assets/sanitize-qwbCpbqt.js","assets/Admin-DlH8c4Ne.js"])))=>i.map(i=>d[i]);
import{r,H as N,a as W,b as D}from"./vendor-helmet-BPZdwhdD.js";import{r as B,u as C,L as c,B as L,R as G,a as p}from"./vendor-react-D2C-z3V_.js";import{C as S,X as O,M as z,a as H,b as V,P as $,A as Y,c as U,Z as _,d as b,T as K,S as X,e as J}from"./vendor-icons-DAaO-fqo.js";import{F as Q,G as Z,C as ee,O as te,N as oe,a as ie,b as ae,c as ne,d as se,e as re}from"./content-articles-Dn4oaumy.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const s of l.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function i(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(a){if(a.ep)return;a.ep=!0;const l=i(a);fetch(a.href,l)}})();var P={exports:{}},w={};/**
 * @license React
...
Agentic AI: Goal → Planning → Execution → Validation → Iteration</pre>
    ...
    `,author:"OpenYourAIs Team",category:"AI Architecture",readTime:"18 min read",publishDate:"3 de Fevereiro, 2026",tags:["AI Agents","Anthropic","Cowork","Automação","Produtividade","Framework SCALE"],image:"https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"},{id:"art-044",slug:"validacao-ia-ideias-negocio-2026",title:"How to Validate Business Ideas With AI Before You Invest (2026 Guide)",excerpt:"Complete guide to using ChatGPT o3, Claude 4 Opus, and other AI tools to validate business ideas in hours, not months. Save thousands on unnecessary MVPs.",content:`
