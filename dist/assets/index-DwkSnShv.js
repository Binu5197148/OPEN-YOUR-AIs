const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ContentPages-ChNdqzJb.js","assets/vendor-helmet-BPZdwhdD.js","assets/vendor-react-3ihRAOJa.js","assets/vendor-icons-vpdDaumG.js","assets/content-articles-DUKyG_pa.js","assets/Admin-DFKnYjoe.js"])))=>i.map(i=>d[i]);
import{r as l,H as I,a as ie,b as ae}from"./vendor-helmet-BPZdwhdD.js";import{r as se,u as G,L as r,a as M,B as oe,R as ne,b as f}from"./vendor-react-3ihRAOJa.js";import{C as $,X as re,M as le,a as ce,b as de,P as he,A as Y,c as pe,Z as F,d as v,T as ue,S as N,e as me,B as ge,f as E,g as H,h as ye,i as fe,j as x,G as be,k as U,l as we,m as xe,D as ve,n as ke}from"./vendor-icons-vpdDaumG.js";import{N as Ae,a as Ie,b as je,c as Te,d as Ne}from"./content-articles-DUKyG_pa.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();var V={exports:{}},S={};/**
 * @license React
 ...
 */var Ce=l,Se=Symbol.for("react.element"),Pe=Symbol.for("react.fragment"),Ee=Object.prototype.hasOwnProperty,Re=Ce.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Me={key:!0,ref:!0,__self:!0,__source:!0};function _(t,i,s){var n,o={},a=null,c=null;s!==void 0&&(a=""+s),i.key!==void 0&&(a=""+i.key),i.ref!==void 0&&(c=i.ref);for(n in i)Ee.call(i,n)&&!Me.hasOwnProperty(n)&&(o[n]=i[n]);if(t&&t.defaultProps)for(n in i=t.defaultProps,i)o[n]===void 0&&(o[n]=i[n]);return{$$typeof:Se,type:t,key:a,ref:c,props:o,_owner:Re.current}}S.Fragment=Pe;S.jsx=_;S.jsxs=_;V.exports=S;var e=V.exports,K,L=se;K=L.createRoot,L.hydrateRoot;const Fe="modulepreload",Oe=function(t){return"/"+t},q={},k=function(i,s,n){let o=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),d=(c==null?void 0:c.nonce)||(c==null?void 0:c.getAttribute("nonce"));o=Promise.allSettled(s.map(h=>{if(h=Oe(h),h in q)return;q[h]=!0;const g=h.endsWith(".css"),p=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${p}`))return;const b=document.createElement("link");if(b.rel=g?"stylesheet":Fe,g||(b.as="script"),b.crossOrigin="",b.href=h,d&&b.setAttribute("nonce",d),document.head.appendChild(b),g)return new Promise((y,u)=>{b.addEventListener("load",y),b.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${h}`)))})}))}function a(c){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=c,window.dispatchEvent(d),!d.defaultPrevented)throw c}return o.then(c=>{for(const d of c||[])d.status==="rejected"&&a(d.reason);return i().catch(a)})},Q=l.createContext({isAuthenticated:!1,login:()=>!1,logout:()=>{}}),De=()=>l.useContext(Q),Le=({children:t})=>{const[i,s]=l.useState(()=>localStorage.getItem("openyourais_admin_session")==="true"),n=a=>a==="password"||a==="admin"?(s(!0),localStorage.setItem("openyourais_admin_session","true"),!0):!1,o=()=>{s(!1),localStorage.removeItem("openyourais_admin_session")};return e.jsx(Q.Provider,{value:{isAuthenticated:i,login:n,logout:o},children:t})},C=({slot:t,format:i="auto",className:s=""})=>e.jsx("div",{className:`w-full overflow-hidden my-8 bg-cyber-bg/50 border border-cyber-primary/10 rounded-2xl flex items-center justify-center min-h-[120px] ${s}`,children:e.jsxs("div",{className:"text-center p-6",children:[e.jsx("span",{className:"text-[10px] text-cyber-primary/40 uppercase tracking-[0.2em] block mb-2",children:"Intelligence Stream Support"}),e.jsxs("div",{className:"w-full h-full bg-black/30 animate-pulse rounded-lg text-cyber-primary/10 text-[10px] flex items-center justify-center uppercase font-black",children:["Transmission Channel: ",t]})]})}),qe=({items:t})=>{const[i,s]=l.useState(null);return e.jsxs("div",{className:"space-y-4 max-w-4xl mx-auto my-16",children:[e.jsx("h3",{className:"text-2xl font-black text-white mb-8 uppercase tracking-widest text-center",children:"Frequently Asked Intel"}),t.map((n,o)=>e.jsxs("div",{className:"border border-white/5 rounded-2xl overflow-hidden bg-white/[0.02]",children:[e.jsxs("button",{onClick:()=>s(i===o?null:o),className:"w-full flex items-center justify-between p-6 text-left hover:bg-white/[0.03] transition-all",children:[e.jsx("span",{className:"font-bold text-gray-200",children:n.q}),i===o?e.jsx(de,{className:"w-4 h-4 text-cyber-primary"}):e.jsx(he,{className:"w-4 h-4 text-gray-500"})]}),i===o&&e.jsx("div",{className:"px-6 pb-6 text-sm text-gray-400 leading-relaxed border-t border-white/5 pt-4",children:n.a})]},o))]})},z=t=>t&&(t.includes("images.unsplash.com")&&!t.includes("fm=webp")?t+(t.includes("?")?"&fm=webp":"?fm=webp"):t),P=({src:t,alt:i,className:s,width:n,height:o})=>{const[a,c]=l.useState(z(t)),[d,h]=l.useState(!1);l.useEffect(()=>{c(z(t))},[t]);const g=()=>{d||(h(!0),c("https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80&fm=webp"))};return e.jsx("img",{src:a,alt:i,className:s,onError:g,width:n,height:o,style:{aspectRatio:n&&o?`${n}/${o}`:"16/9"},loading:"lazy"})},ze=()=>{const[t,i]=l.useState(!1);l.useEffect(()=>{if(!localStorage.getItem("openyourais_cookie_consent")){const o=setTimeout(()=>i(!0),1500);return()=>clearTimeout(o)}},[]);const s=()=>{localStorage.setItem("openyourais_cookie_consent","true"),i(!1)};return t?e.jsx("div",{className:"fixed bottom-6 left-6 right-6 z-[100] md:max-w-xl md:left-auto p-6 bg-black/90 backdrop-blur-2xl border border-cyber-primary/20 rounded-[32px] shadow-2xl",children:e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"bg-cyber-primary/10 p-3 rounded-2xl",children:e.jsx(ce,{className:"text-cyber-primary w-6 h-6"})}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-white font-black text-sm uppercase",children:"Data Consent Protocol"}),e.jsx("p",{className:"text-[10px] text-gray-400 leading-tight mt-1",children:"We utilize cookies to optimize your neural interface experience and maintain the intelligence stream."})]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("button",{onClick:s,className:"flex-1 py-3 bg-cyber-primary text-cyber-bg font-black rounded-xl hover:brightness-110 transition-all text-[10px] uppercase tracking-widest",children:"Acknowledge"}),e.jsx(r,{to:"/privacy",className:"flex-1 py-3 border border-white/10 text-white font-black rounded-xl hover:bg-white/5 transition-all text-[10px] uppercase tracking-widest text-center",children:"Review Data"})]})]})}):null},We=()=>{const[t,i]=l.useState(!1),s=G(),{isAuthenticated:n}=De(),o=[{name:"TOOLS",path:"/tools"},{name:"PLAYBOOKS",path:"/playbooks"},{name:"CRYPTO",path:"/crypto"},{name:"INTEL",path:"/blog"}],a=c=>s.pathname===c;return e.jsx("nav",{className:"fixed w-full z-50 top-0 start-0 border-b border-white/5 bg-cyber-bg/80 backdrop-blur-xl",role:"navigation","aria-label":"Main navigation",children:e.jsxs("div",{className:"max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:p-6",children:[e.jsxs(r,{to:"/",className:"flex items-center space-x-2 md:space-x-3 group","aria-label":"Open Your AIs - Home",children:[e.jsxs("div",{className:"relative w-8 h-8 md:w-10 md:h-10 bg-cyber-primary rounded-xl flex items-center justify-center group-hover:shadow-[0_0_20px_#00E5FF] transition-all duration-500 overflow-hidden",children:[e.jsx($,{className:"text-cyber-bg w-4 h-4 md:w-6 md:h-6 z-10"}),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-white/40 to-transparent opacity-50"})]}),e.jsxs("span",{className:"self-center text-sm md:text-xl font-black whitespace-nowrap tracking-tighter text-white uppercase italic",children:["OPEN YOUR ",e.jsx("span",{className:"text-cyber-primary",children:"AIS"})]})]}),e.jsxs("div",{className:"flex md:order-2 items-center gap-2",children:[e.jsx(r,{to:"/admin",className:"hidden md:inline-block px-6 py-2.5 text-[10px] font-black text-cyber-bg bg-cyber-primary rounded-full hover:shadow-[0_0_20px_rgba(0,229,255,0.4)] transition-all uppercase tracking-widest",children:n?"TERMINAL":"CONNECT"}),e.jsx("button",{onClick:()=>i(!t),className:"inline-flex items-center p-2 w-10 h-10 justify-center text-white md:hidden hover:bg-white/10 rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-cyber-primary","aria-expanded":t,"aria-controls":"main-nav-menu","aria-label":t?"Close navigation menu":"Open navigation menu",children:t?e.jsx(re,{"aria-hidden":"true"}):e.jsx(le,{"aria-hidden":"true"})})]}),e.jsx("div",{id:"main-nav-menu",className:`items-center justify-between w-full md:flex md:w-auto md:order-1 ${t?"block":"hidden"}`,children:e.jsxs("ul",{className:"flex flex-col p-4 md:p-0 mt-4 md:space-x-8 lg:space-x-12 md:flex-row md:mt-0 font-black text-xs md:text-[10px] tracking-widest md:tracking-[0.2em] uppercase bg-cyber-bg/95 md:bg-transparent rounded-2xl md:rounded-none border border-white/10 md:border-0",children:[o.map(c=>e.jsx("li",{children:e.jsx(r,{to:c.path,className:`block py-3 px-4 md:py-2 md:px-0 rounded-lg md:rounded-none transition-all ${a(c.path)?"text-cyber-primary bg-cyber-primary/10 md:bg-transparent":"text-gray-400 hover:text-white hover:bg-white/5 md:hover:bg-transparent"}`,onClick:()=>i(!1),children:c.name})},c.name)),e.jsx("li",{className:"md:hidden mt-2 pt-2 border-t border-white/10",children:e.jsx(r,{to:"/admin",className:"block py-3 px-4 text-cyber-primary font-black",onClick:()=>i(!1),children:n?"TERMINAL":"CONNECT"})})]})})]})})},Be=()=>e.jsx("footer",{className:"bg-black/60 border-t border-white/5 mt-16 md:mt-32 py-12 md:py-20",children:e.jsxs("div",{className:"mx-auto w-full max-w-screen-xl px-4 md:px-6",children:[e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16",children:[e.jsxs("div",{className:"col-span-2",children:[e.jsxs(r,{to:"/",className:"flex items-center space-x-2 md:space-x-3 mb-4 md:mb-6",children:[e.jsx("div",{className:"w-6 h-6 md:w-8 md:h-8 bg-cyber-primary rounded-lg flex items-center justify-center",children:e.jsx($,{className:"text-cyber-bg w-3 h-3 md:w-4 md:h-4"})}),e.jsx("span",{className:"text-base md:text-xl font-black text-white uppercase italic",children:"OPEN YOUR AIS"})]}),e.jsx("p",{className:"text-gray-500 text-xs md:text-sm max-w-sm leading-relaxed font-light",children:"The premier intelligence hub for the digital vanguard. We decode the future of AI, decentralized assets, and monetization protocols."})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"mb-4 md:mb-6 text-[9px] md:text-[10px] font-black text-white uppercase tracking-widest md:tracking-[0.3em]",children:"Network"}),e.jsxs("ul",{className:"text-gray-500 text-[10px] md:text-xs space-y-3 md:space-y-4 font-bold uppercase tracking-wider md:tracking-widest",children:[e.jsx("li",{children:e.jsx(r,{to:"/tools",className:"hover:text-cyber-primary transition-colors",children:"AI Directory"})}),e.jsx("li",{children:e.jsx(r,{to:"/playbooks",className:"hover:text-cyber-primary transition-colors",children:"Revenue Ops"})}),e.jsx("li",{children:e.jsx(r,{to:"/crypto",className:"hover:text-cyber-primary transition-colors",children:"Crypto Vault"})}),e.jsx("li",{children:e.jsx(r,{to:"/blog",className:"hover:text-cyber-primary transition-colors",children:"Blog"})}),e.jsx("li",{children:e.jsx(r,{to:"/sitemap",className:"hover:text-cyber-primary transition-colors",children:"Site Map"})})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"mb-4 md:mb-6 text-[9px] md:text-[10px] font-black text-white uppercase tracking-widest md:tracking-[0.3em]",children:"Company"}),e.jsxs("ul",{className:"text-gray-500 text-[10px] md:text-xs space-y-3 md:space-y-4 font-bold uppercase tracking-wider md:tracking-widest",children:[e.jsx("li",{children:e.jsx(r,{to:"/about",className:"hover:text-cyber-primary transition-colors",children:"About Us"})}),e.jsx("li",{children:e.jsx(r,{to:"/contact",className:"hover:text-cyber-primary transition-colors",children:"Contact"})}),e.jsx("li",{children:e.jsx(r,{to:"/privacy",className:"hover:text-cyber-primary transition-colors",children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(r,{to:"/terms",className:"hover:text-cyber-primary transition-colors",children:"Terms of Service"})})]})]})]}),e.jsxs("div",{className:"pt-8 md:pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 text-[8px] md:text-[9px] font-black text-gray-700 uppercase tracking-widest md:tracking-[0.4em]",children:[e.jsx("span",{children:"© 2026 OPEN YOUR AIS"}),e.jsxs("div",{className:"flex gap-4 md:gap-8",children:[e.jsx("span",{children:"SECURE DATA"}),e.jsx("span",{children:"HIGH-FIDELITY"})]})]})]})}),Ge=({children:t})=>e.jsxs("div",{className:"min-h-screen flex flex-col relative overflow-x-hidden selection:bg-cyber-primary selection:text-cyber-bg",children:[e.jsx("div",{className:"fixed inset-0 z-[-1] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-10"}),e.jsx(We,{}),e.jsx("main",{className:"flex-grow pt-24 px-4 md:px-0",children:t}),e.jsx(Be,{}),e.jsx(ze,{})]}),m=({children:t,className:i="",hoverEffect:s=!0})=>e.jsxs("div",{className:`glass-panel rounded-[32px] p-8 border border-white/5 relative overflow-hidden group ${s?"hover:border-cyber-primary/40 transition-all duration-500":""} ${i}`,children:[s&&e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-cyber-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"}),t]}),A=({title:t,subtitle:i})=>e.jsxs("div",{className:"text-center mb-8 md:mb-16",children:[e.jsx("h2",{className:"text-2xl md:text-4xl lg:text-6xl font-black text-white mb-3 md:mb-6 uppercase tracking-tight md:tracking-tighter leading-tight",children:t}),i&&e.jsx("p",{className:"text-gray-500 max-w-2xl mx-auto text-sm md:text-lg font-light tracking-wide px-4",children:i})]}),$e=[{id:"art-047",slug:"from-50k-productions-to-ai-what-directing-taught-me",title:"From $50K Productions to AI: What 14 Years of Directing Taught Me About the Future",excerpt:"I produced a $47,000 Nestlé commercial in 2015. Last month I recreated a similar shot with AI for $3. But here's what happened next.",content:`
    ...
    `}],Ye=[{id:"cg1",title:"Ironclad Security: The Digital Custody Protocol",level:"Beginner",summary:"The definitive guide to shielding your digital assets against cyber attacks.",content:`
...
- Break-even point e ROI esperado em 24 meses"</pre>
    ...
    `,category:"Crypto",tags:["Market Intel","Bitcoin","Stablecoins","Institutional","Data Analysis"],date:"Feb 7, 2026",readTime:"8 min",image:"https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=800&q=80"}],O=[...$e,...He,...Ae,...Ie,...je,...Te,...Ne],W=[{q:"What is the mission of Open Your AIs?",a:"Our mission is to decode complex technological shifts and provide actionable intelligence to ensure digital sovereignty. We focus on AI automation, decentralized finance, and future-proof monetization strategies."},{q:"Are the monetization playbooks verified?",a:"Yes. Every playbook published in our directory undergoes a theoretical and practical audit. We analyze ROI, time-to-market, and technical feasibility before listing any strategy."},{q:"How often is the intelligence feed updated?",a:"Our analysts monitor the neural frontier 24/7. High-priority intelligence reports are released daily, while deep-dive playbooks are updated on a weekly basis."},{q:"Is this platform suitable for beginners?",a:"Absolutely. We provide tiered content ranging from 'Entry Level' crypto guides to 'Hard Difficulty' technical playbooks, ensuring a clear learning path for all tech levels."}],Ue=()=>e.jsxs("section",{className:"relative min-h-[95vh] flex items-center justify-center overflow-hidden pt-10",children:[e.jsx("div",{className:"absolute inset-0 bg-cyber-bg z-[-1]"}),e.jsx("div",{className:"absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-cyber-primary/20 blur-[150px] rounded-full z-[-1] animate-pulse"}),e.jsxs("div",{className:"container mx-auto px-4 text-center z-10",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 md:gap-3 mb-6 md:mb-8 px-4 md:px-6 py-2 rounded-full border border-white/10 bg-white/5 text-cyber-primary text-[8px] md:text-[10px] font-black tracking-wider md:tracking-[0.3em] uppercase",children:[e.jsx(Y,{className:"w-3 h-3 md:w-4 md:h-4"})," Tech Intelligence Hub 2026"]}),e.jsxs("h1",{className:"text-4xl md:text-6xl lg:text-9xl font-black tracking-tight md:tracking-tighter mb-6 md:mb-8 leading-[0.9] uppercase",children:[e.jsx("span",{className:"block text-white",children:"RECODE YOUR"}),e.jsx("span",{className:"bg-clip-text text-transparent bg-gradient-neon",children:"DIGITAL FUTURE"})]}),e.jsxs("p",{className:"text-base md:text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto mb-8 md:mb-14 leading-relaxed font-light px-4",children:["High-fidelity intelligence for the modern elite. Master ",e.jsx("span",{className:"text-white font-bold",children:"Generative AI"}),", secure ",e.jsx("span",{className:"text-white font-bold",children:"Crypto Protocols"}),", and automated ",e.jsx("span",{className:"text-white font-bold",children:"Revenue Frameworks"}),"."]}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4 md:gap-6 justify-center px-4",children:[e.jsxs(r,{to:"/tools",className:"group px-8 md:px-12 py-4 md:py-6 bg-cyber-primary text-cyber-bg font-black rounded-full hover:bg-white transition-all shadow-[0_0_40px_rgba(0,229,255,0.4)] flex items-center justify-center gap-3 uppercase tracking-widest text-xs md:text-sm",children:["Access Tools ",e.jsx(pe,{className:"w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform"})]}),e.jsx(r,{to:"/playbooks",className:"px-8 md:px-12 py-4 md:py-6 bg-white/5 border border-white/10 text-white font-black rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-3 uppercase tracking-widest text-xs md:text-sm backdrop-blur-md",children:"Monetization"})]})]})]}),Ve=()=>e.jsxs("section",{className:"py-12 md:py-24 container mx-auto px-4",children:[e.jsx(A,{title:"Core Specializations",subtitle:"Systematic frameworks for the post-work era."}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10",children:[e.jsxs(m,{className:"text-center p-6 md:p-10 border-b-4 border-b-cyber-primary hover:bg-cyber-primary/5 transition-all",children:[e.jsx("div",{className:"w-14 h-14 md:w-20 md:h-20 mx-auto bg-cyber-primary/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-4 md:mb-8 text-cyber-primary border border-cyber-primary/20",children:e.jsx(F,{className:"w-6 h-6 md:w-10 md:h-10"})}),e.jsx("h3",{className:"text-lg md:text-2xl font-black text-white mb-3 md:mb-6 uppercase tracking-wider md:tracking-widest",children:"AI & LLMs"}),e.jsx("p",{className:"text-gray-400 text-xs md:text-sm mb-4 md:mb-8 leading-relaxed",children:"Deep analysis of LLM architectures, visual generators, and agentic workflows to augment human output."}),e.jsxs(r,{to:"/tools",className:"inline-flex items-center gap-2 text-cyber-primary font-black text-[9px] md:text-[10px] uppercase tracking-wider md:tracking-[0.2em] hover:text-white transition-all",children:["Connect ",e.jsx(v,{className:"w-3 h-3"})]})]}),e.jsxs(m,{className:"text-center p-6 md:p-10 border-b-4 border-b-cyber-secondary hover:bg-cyber-secondary/5 transition-all",children:[e.jsx("div",{className:"w-14 h-14 md:w-20 md:h-20 mx-auto bg-cyber-secondary/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-4 md:mb-8 text-cyber-secondary border border-cyber-secondary/20",children:e.jsx(ue,{className:"w-6 h-6 md:w-10 md:h-10"})}),e.jsx("h3",{className:"text-lg md:text-2xl font-black text-white mb-3 md:mb-6 uppercase tracking-wider md:tracking-widest",children:"Digital Capital"}),e.jsx("p",{className:"text-gray-400 text-xs md:text-sm mb-4 md:mb-8 leading-relaxed",children:"Actionable, validated playbooks for capital generation using automated systems and artificial intelligence."}),e.jsxs(r,{to:"/playbooks",className:"inline-flex items-center gap-2 text-cyber-secondary font-black text-[9px] md:text-[10px] uppercase tracking-wider md:tracking-[0.2em] hover:text-white transition-all",children:["Execute ",e.jsx(v,{className:"w-3 h-3"})]})]}),e.jsxs(m,{className:"text-center p-6 md:p-10 border-b-4 border-b-cyber-success hover:bg-cyber-success/5 transition-all",children:[e.jsx("div",{className:"w-14 h-14 md:w-20 md:h-20 mx-auto bg-cyber-success/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-4 md:mb-8 text-cyber-success border border-cyber-success/20",children:e.jsx(N,{className:"w-6 h-6 md:w-10 md:h-10"})}),e.jsx("h3",{className:"text-lg md:text-2xl font-black text-white mb-3 md:mb-6 uppercase tracking-wider md:tracking-widest",children:"Web3 Protocol"}),e.jsx("p",{className:"text-gray-400 text-xs md:text-sm mb-4 md:mb-8 leading-relaxed",children:"Security-first documentation for digital asset self-custody and blockchain market fundamentals."}),e.jsxs(r,{to:"/crypto",className:"inline-flex items-center gap-2 text-cyber-success font-black text-[10px] uppercase tracking-[0.2em] hover:text-white transition-all",children:["Access Vault ",e.jsx(v,{className:"w-3 h-3"})]})]})]})]}),_e=()=>{const t=O.slice(0,3);return e.jsx("section",{className:"py-24 bg-black/20",children:e.jsxs("div",{className:"container mx-auto px-4",children:[e.jsx(A,{title:"Neural Intel Updates",subtitle:"Direct transmission from the technical frontlines."}),e.jsx("div",{className:"grid md:grid-cols-3 gap-8 mb-16",children:t.map(i=>e.jsx(r,{to:`/blog/${i.slug}`,className:"group",children:e.jsxs(m,{className:"h-full flex flex-col p-0 rounded-3xl overflow-hidden border-white/5 hover:border-cyber-primary/20",children:[e.jsxs("div",{className:"aspect-video w-full overflow-hidden relative border-b border-white/5 bg-gray-900",children:[e.jsx(P,{src:i.image||"",alt:i.title,className:"w-full h-full object-cover opacity-60 group-hover:scale-105 transition-all duration-700",width:800,height:450}),e.jsx("div",{className:"absolute top-4 left-4 bg-cyber-bg/90 backdrop-blur px-3 py-1 text-[9px] font-black uppercase rounded-sm border border-white/10 text-cyber-primary tracking-widest",children:i.category})]}),e.jsxs("div",{className:"p-8",children:[e.jsx("h3",{className:"text-xl font-black text-white mb-4 line-clamp-2 uppercase tracking-wide leading-tight group-hover:text-cyber-primary transition-colors",children:i.title}),e.jsx("p",{className:"text-gray-500 text-sm line-clamp-2 font-light leading-relaxed",children:i.excerpt})]})]})},i.id))}),e.jsx("div",{className:"text-center",children:e.jsx(r,{to:"/blog",className:"inline-block px-10 py-4 border border-white/10 rounded-full text-gray-500 font-black uppercase text-[10px] tracking-widest hover:border-cyber-primary transition-all",children:"Browse Intelligence Archive"})})]})})},Ke=()=>{const[t,i]=l.useState(""),[s,n]=l.useState("idle"),[o,a]=l.useState(""),c=async d=>{if(d.preventDefault(),!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)){n("error"),a("Please enter a valid email address");return}n("loading");try{await new Promise(p=>setTimeout(p,1500));const g=JSON.parse(localStorage.getItem("neural-stream-subscribers")||"[]");if(!g.find(p=>p.email===t)){const p={email:t,timestamp:Date.now(),source:"neural-stream",page:window.location.pathname,userAgent:navigator.userAgent.slice(0,100)};g.push(p),localStorage.setItem("neural-stream-subscribers",JSON.stringify(g)),typeof window.gtag=="function"&&window.gtag("event","newsletter_signup",{method:"neural_stream",custom_parameter:"homepage"})}n("success"),a("Welcome to the AI Opportunity Inner Circle! 🚀"),i(""),setTimeout(()=>{n("idle"),a("")},4e3)}catch{n("error"),a("Connection failed. Please try again."),setTimeout(()=>{n("idle"),a("")},3e3)}};return e.jsx("div",{className:"py-24 border-t border-white/5",children:e.jsxs(m,{className:"max-w-4xl mx-auto bg-gradient-to-br from-cyber-primary/5 to-transparent border-cyber-primary/10 p-16 rounded-[40px] text-center",children:[e.jsx("h2",{className:"text-4xl font-black text-white mb-6 uppercase tracking-widest",children:"Neural Stream"}),e.jsx("p",{className:"text-gray-400 mb-12 max-w-xl mx-auto text-lg font-light",children:"Join the vanguard. Receive technical deep-dives and market alerts directly to your inbox."}),e.jsxs("form",{onSubmit:c,className:"max-w-md mx-auto relative group",children:[e.jsx("input",{type:"email",value:t,onChange:d=>i(d.target.value),placeholder:"NEURAL_ID@EMAIL.COM",disabled:s==="loading"||s==="success",className:"w-full bg-black/60 border border-white/10 rounded-full py-6 px-10 text-xs focus:outline-none focus:border-cyber-primary transition-all uppercase font-black tracking-widest disabled:opacity-50"}),e.jsx("button",{type:"submit",disabled:s==="loading"||s==="success",className:`absolute right-2 top-2 px-10 py-4 rounded-full font-black text-[10px] uppercase tracking-widest transition-all disabled:opacity-50 ${s==="success"?"bg-cyber-success text-white":"bg-cyber-primary text-cyber-bg hover:shadow-[0_0_25px_#00E5FF]"}`,children:s==="loading"?"CONNECTING...":s==="success"?e.jsxs(e.Fragment,{children:[e.jsx(me,{className:"w-3 h-3 inline mr-1"}),"CONNECTED"]}):"CONNECT"})]}),o&&e.jsx("div",{className:`mt-6 text-sm font-bold ${s==="success"?"text-cyber-success":"text-red-400"}`,children:o})]})})},Qe=()=>{l.useEffect(()=>{document.title="Open Your AIs | AI, Crypto & Digital Monetization Intelligence"},[]);const t={"@context":"https://schema.org","@type":"Organization",name:"Open Your AIs",url:"https://www.openyourais.com",logo:"https://www.openyourais.com/logo.png",description:"Technology intelligence platform providing expert analysis on AI tools, cryptocurrency strategies, and digital monetization playbooks.",email:"openyourais888@gmail.com",sameAs:[]},i={"@context":"https://schema.org","@type":"FAQPage",mainEntity:W.map(s=>({"@type":"Question",name:s.q,acceptedAnswer:{"@type":"Answer",text:s.a}}))};return e.jsxs(e.Fragment,{children:[e.jsxs(I,{children:[e.jsx("title",{children:"Open Your AIs | AI, Crypto & Digital Monetization Intelligence"}),e.jsx("meta",{name:"description",content:"Master Artificial Intelligence, Cryptocurrency, and Digital Monetization with expert guides. Discover the best AI tools, crypto strategies, and proven monetization playbooks for 2026."}),e.jsx("meta",{name:"keywords",content:"AI tools, artificial intelligence, cryptocurrency, digital monetization, make money online, ChatGPT, Claude AI, crypto trading, passive income, tech tutorials 2026"}),e.jsx("link",{rel:"canonical",href:"https://www.openyourais.com/"}),e.jsx("meta",{property:"og:title",content:"Open Your AIs | AI, Crypto & Digital Monetization Intelligence"}),e.jsx("meta",{property:"og:description",content:"Master Artificial Intelligence, Cryptocurrency, and Digital Monetization with expert guides and proven strategies."}),e.jsx("meta",{property:"og:type",content:"website"}),e.jsx("meta",{property:"og:url",content:"https://www.openyourais.com/"}),e.jsx("meta",{property:"og:image",content:"https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=1200&q=80&fm=webp"}),e.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),e.jsx("meta",{name:"twitter:title",content:"Open Your AIs | AI, Crypto & Digital Monetization Intelligence"}),e.jsx("meta",{name:"twitter:description",content:"Master AI, Crypto, and Digital Monetization with expert guides."}),e.jsx("meta",{name:"twitter:image",content:"https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=1200&q=80&fm=webp"}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(t)}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(i)})]}),e.jsx(Ue,{}),e.jsxs("div",{className:"container mx-auto px-4",children:[e.jsx(C,{slot:"home-top"}),e.jsx(Ve,{}),e.jsx(_e,{}),e.jsx(qe,{items:W}),e.jsx(Ke,{})]})]})},j=()=>(l.useEffect(()=>{document.title="404 Not Found | Open Your AIs"},[]),e.jsxs("div",{className:"min-h-[70vh] flex flex-col items-center justify-center text-center px-4",children:[e.jsx("h1",{className:"text-6xl md:text-9xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyber-primary to-cyber-secondary mb-4 animate-pulse",children:"404"}),e.jsx("h2",{className:"text-2xl text-white mb-6 tracking-widest uppercase font-black",children:"Transmission Lost in Neural Net"}),e.jsx(r,{to:"/",className:"px-12 py-4 bg-cyber-primary text-cyber-bg font-black rounded-full hover:shadow-[0_0_25px_rgba(0,229,255,0.5)] transition-all uppercase tracking-widest text-xs",children:"Return to Nexus"})]})),X=()=>(l.useEffect(()=>{document.title="Sitemap | Open Your AIs"},[]),e.jsxs("div",{className:"container mx-auto px-4 py-12",children:[e.jsx(A,{title:"System Sitemap",subtitle:"Systematic Index of all published intelligence protocols."}),e.jsx(m,{children:e.jsxs("div",{className:"grid md:grid-cols-3 gap-12 text-sm uppercase font-black tracking-widest",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-cyber-primary mb-6 border-b border-white/10 pb-2",children:"Navigation"}),e.jsxs("ul",{className:"space-y-4 text-gray-500 text-[10px]",children:[e.jsx("li",{children:e.jsx(r,{to:"/",className:"hover:text-white transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(r,{to:"/tools",className:"hover:text-white transition-colors",children:"AI Tools Directory"})}),e.jsx("li",{children:e.jsx(r,{to:"/playbooks",className:"hover:text-white transition-colors",children:"Monetization Playbooks"})}),e.jsx("li",{children:e.jsx(r,{to:"/crypto",className:"hover:text-white transition-colors",children:"Crypto Intelligence"})}),e.jsx("li",{children:e.jsx(r,{to:"/blog",className:"hover:text-white transition-colors",children:"Blog"})}),e.jsx("li",{children:e.jsx(r,{to:"/about",className:"hover:text-white transition-colors",children:"About Us"})}),e.jsx("li",{children:e.jsx(r,{to:"/contact",className:"hover:text-white transition-colors",children:"Contact"})}),e.jsx("li",{children:e.jsx(r,{to:"/privacy",className:"hover:text-white transition-colors",children:"Privacy Policy"})}),e.jsx("li",{children:e.jsx(r,{to:"/terms",className:"hover:text-white transition-colors",children:"Terms of Service"})})]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-cyber-secondary mb-6 border-b border-white/10 pb-2",children:"Playbooks"}),e.jsx("ul",{className:"space-y-4 text-gray-500 text-[10px]",children:J.map(t=>e.jsx("li",{children:e.jsx(r,{to:`/playbooks/${t.id}`,className:"hover:text-white transition-colors",children:t.title})},t.id))})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-cyber-success mb-6 border-b border-white/10 pb-2",children:"Recent Intel"}),e.jsx("ul",{className:"space-y-4 text-gray-500 text-[10px]",children:O.map(t=>e.jsx("li",{children:e.jsx(r,{to:`/blog/${t.slug}`,className:"hover:text-white transition-colors",children:t.title})},t.id))})]})]})})]})),Je=()=>{const{slug:t}=M(),[i,s]=l.useState(0),a=[...JSON.parse(localStorage.getItem("openyourais_new_articles")||"[]"),...O].find(p=>p.slug===t);if(l.useEffect(()=>{window.scrollTo(0,0),a&&(document.title=`${a.title} | Open Your AIs`);const p=()=>{const b=document.documentElement.scrollHeight-window.innerHeight,y=window.scrollY;s(y/b*100)};return window.addEventListener("scroll",p),()=>window.removeEventListener("scroll",p)},[t,a]),!a)return e.jsx(j,{});const c=a.excerpt?a.excerpt.length>160?a.excerpt.substring(0,157)+"...":a.excerpt:`Read ${a.title} - High-fidelity intelligence on ${a.category} from Open Your AIs.`,d=[a.category,...a.tags||[],"AI","technology","guide"].join(", "),h={"@context":"https://schema.org","@type":"BlogPosting",headline:a.title,description:c,image:a.image,author:{"@type":"Organization",name:"Open Your AIs"},publisher:{"@type":"Organization",name:"Open Your AIs",logo:{"@type":"ImageObject",url:"https://www.openyourais.com/logo.png"}},datePublished:a.date||new Date().toISOString(),mainEntityOfPage:{"@type":"WebPage","@id":`https://www.openyourais.com/blog/${a.slug}`}},g={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://www.openyourais.com/"},{"@type":"ListItem",position:2,name:"Blog",item:"https://www.openyourais.com/blog"},{"@type":"ListItem",position:3,name:a.title,item:`https://www.openyourais.com/blog/${a.slug}`}]};return e.jsxs("div",{className:"relative",children:[e.jsxs(I,{children:[e.jsx("title",{children:`${a.title} | Open Your AIs`}),e.jsx("meta",{name:"description",content:c}),e.jsx("meta",{name:"keywords",content:d}),e.jsx("link",{rel:"canonical",href:`https://www.openyourais.com/blog/${a.slug}`}),e.jsx("meta",{property:"og:title",content:`${a.title} | Open Your AIs`}),e.jsx("meta",{property:"og:description",content:c}),e.jsx("meta",{property:"og:type",content:"article"}),e.jsx("meta",{property:"og:url",content:`https://www.openyourais.com/blog/${a.slug}`}),e.jsx("meta",{property:"og:image",content:a.image}),e.jsx("meta",{property:"article:published_time",content:a.date}),e.jsx("meta",{property:"article:section",content:a.category}),(a.tags||[]).map(p=>e.jsx("meta",{property:"article:tag",content:p},p)),e.jsx("meta",{name:"twitter:title",content:`${a.title} | Open Your AIs`}),e.jsx("meta",{name:"twitter:description",content:c}),e.jsx("meta",{name:"twitter:image",content:a.image}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(h)}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(g)})]}),e.jsx("div",{className:"fixed top-[88px] left-0 w-full h-1 bg-white/5 z-[60]",children:e.jsx("div",{className:"h-full bg-cyber-primary shadow-[0_0_10px_#00E5FF] transition-all duration-300",style:{width:`${i}%`}})}),e.jsx("article",{className:"container mx-auto px-4 py-12 max-w-5xl",children:e.jsxs("div",{className:"flex flex-col lg:flex-row gap-16",children:[e.jsxs("div",{className:"lg:w-3/4",children:[e.jsx("nav",{"aria-label":"Breadcrumb",className:"mb-8",children:e.jsxs("ol",{className:"flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("li",{children:e.jsx(r,{to:"/",className:"hover:text-white transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(v,{className:"w-3 h-3"})}),e.jsx("li",{children:e.jsx(r,{to:"/blog",className:"hover:text-white transition-colors",children:"Blog"})}),e.jsx("li",{children:e.jsx(v,{className:"w-3 h-3"})}),e.jsx("li",{className:"text-cyber-primary truncate max-w-[200px]","aria-current":"page",children:a.title})]})}),e.jsxs("header",{className:"mb-12",children:[e.jsxs("div",{className:"flex flex-wrap items-center gap-6 mb-8",children:[e.jsxs("span",{className:"px-4 py-1.5 text-[9px] font-black tracking-[0.2em] text-cyber-bg bg-cyber-primary rounded-sm uppercase italic",children:[a.category," Protocol"]}),e.jsxs("span",{className:"text-gray-500 text-[9px] font-black uppercase tracking-[0.2em] flex items-center gap-2",children:[e.jsx(H,{className:"w-3.5 h-3.5"})," ",a.readTime," cycle"]}),e.jsxs("span",{className:"text-cyber-success text-[9px] font-black uppercase tracking-[0.2em] flex items-center gap-2 border border-cyber-success/20 px-3 py-1 rounded",children:[e.jsx(N,{className:"w-3.5 h-3.5"})," Data Verified"]})]}),e.jsx("h1",{className:"text-4xl md:text-7xl font-black text-white mb-8 leading-[0.95] tracking-tighter uppercase italic",children:a.title}),e.jsxs("div",{className:"flex items-center gap-4 border-t border-white/5 pt-8",children:[e.jsx("div",{className:"w-10 h-10 rounded-full bg-cyber-primary/20 flex items-center justify-center text-cyber-primary font-black italic text-xs border border-cyber-primary/30",children:"OY"}),e.jsxs("div",{className:"text-[10px] uppercase font-black tracking-widest text-gray-400",children:[e.jsx("span",{className:"text-white",children:"Admin Analyst"})," â€¢ Feb 2026 â€¢ Alpha Priority"]})]})]}),e.jsx("div",{className:"w-full aspect-video rounded-[40px] overflow-hidden mb-16 border border-white/5 bg-gray-900 group shadow-2xl",children:e.jsx(P,{src:a.image,alt:a.title,className:"w-full h-full object-cover opacity-70 group-hover:scale-105 transition-all duration-1000",width:1200,height:675})}),e.jsxs("div",{className:"prose prose-invert prose-lg max-w-none",children:[e.jsxs("div",{className:"p-12 bg-white/[0.02] border-l-8 border-cyber-primary rounded-r-[40px] mb-16 text-gray-300 text-2xl font-light leading-relaxed italic border border-white/5 shadow-xl",children:['"',a.excerpt,'"']}),e.jsx(C,{slot:"article-top"}),e.jsx("div",{className:"article-content leading-[1.9] space-y-12 text-gray-300 font-normal prose-h2:text-white prose-h2:font-black prose-h2:uppercase prose-h2:text-4xl prose-h2:mt-24 prose-h2:mb-8 prose-h3:text-cyber-primary prose-h3:font-bold prose-h3:text-2xl prose-p:mb-8 prose-ul:mb-8 prose-li:mb-2",dangerouslySetInnerHTML:{__html:a.content}}),e.jsx("div",{className:"mt-24 pt-12 border-t border-white/10",children:e.jsx("div",{className:"flex flex-wrap gap-4",children:(a.tags||[]).map(p=>e.jsxs("span",{className:"text-[10px] font-black bg-white/5 px-4 py-2 rounded-lg text-gray-400 uppercase tracking-widest border border-white/5",children:["#",p]},p))})}),e.jsx(C,{slot:"article-bottom"})]}),e.jsxs("div",{className:"mt-24 p-12 bg-gradient-to-br from-cyber-primary/10 to-transparent border border-cyber-primary/20 rounded-[48px] relative overflow-hidden group",children:[e.jsx("div",{className:"absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity",children:e.jsx(N,{className:"w-32 h-32"})}),e.jsxs("h3",{className:"text-2xl font-black text-white mb-6 uppercase tracking-widest flex items-center gap-3",children:[e.jsx(N,{className:"text-cyber-primary w-8 h-8"})," Neural Integrity Protocol"]}),e.jsx("p",{className:"text-gray-400 leading-relaxed text-base font-light mb-8 italic",children:"This documentation was compiled through a high-frequency intelligence network. Every technical claim was cross-referenced with primary market sources to ensure human sovereignty in the age of total automation."}),e.jsxs("div",{className:"flex gap-4",children:[e.jsxs("button",{className:"px-8 py-3 bg-cyber-primary text-cyber-bg font-black rounded-xl text-[10px] uppercase tracking-widest hover:brightness-110 transition-all flex items-center gap-2",children:[e.jsx(ye,{className:"w-4 h-4"})," Broadcast Intel"]}),e.jsxs("button",{className:"px-8 py-3 border border-white/10 text-white font-black rounded-xl text-[10px] uppercase tracking-widest hover:bg-white/5 transition-all flex items-center gap-2",children:[e.jsx(fe,{className:"w-4 h-4"})," Save to Vault"]})]})]})]}),e.jsx("aside",{className:"lg:w-1/4",children:e.jsxs("div",{className:"sticky top-32 space-y-12",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"font-black text-white uppercase tracking-[0.3em] text-[9px] mb-8 border-b border-white/10 pb-2",children:"Transmission Status"}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("span",{children:"Stream"}),e.jsx("span",{className:"text-cyber-success flex items-center gap-1 font-black underline decoration-cyber-success/30 decoration-2 underline-offset-4",children:"OPTIMIZED"})]}),e.jsxs("div",{className:"flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("span",{children:"Expertise"}),e.jsx("span",{className:"text-white",children:"SENIOR ANALYST"})]}),e.jsxs("div",{className:"flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("span",{children:"Analysis"}),e.jsx("span",{className:"text-cyber-primary",children:"DEEP DIVE"})]})]})]}),e.jsxs("div",{className:"p-8 bg-cyber-primary/5 rounded-[32px] border border-cyber-primary/10",children:[e.jsx("h4",{className:"font-black text-white uppercase tracking-widest text-[10px] mb-4",children:"Neural Pulse"}),e.jsx("p",{className:"text-[11px] text-gray-500 leading-relaxed mb-6 italic",children:"Join 15,000+ vanguard thinkers receiving daily high-frequency technical alerts."}),e.jsx("input",{type:"email",placeholder:"NEURAL_ID@HOST.COM",className:"w-full bg-black/60 border border-white/10 rounded-xl py-3 px-4 text-[10px] font-black uppercase tracking-widest text-cyber-primary focus:outline-none focus:border-cyber-primary mb-3"}),e.jsx("button",{className:"w-full py-3 bg-cyber-primary text-cyber-bg font-black rounded-xl text-[10px] uppercase tracking-widest hover:shadow-[0_0_15px_#00E5FF]",children:"Subscribe"})]}),e.jsx(C,{slot:"sidebar-ad",className:"min-h-[400px]"})]})})]})})]})},Xe=()=>{const{id:t}=M(),i=J.find(y=>y.id===t),[s,n]=l.useState(!1),[o,a]=l.useState(!1),[c,d]=l.useState([]),[h,g]=l.useState([]);l.useEffect(()=>{window.scrollTo(0,0),i&&(document.title=`${i.title} | Playbook`),localStorage.getItem(`mission_${t}`)==="active"&&a(!0);const u=localStorage.getItem(`checked_${t}`);u&&g(JSON.parse(u))},[t,i]);const p=()=>{n(!0);const y=["Establishing Neural Link...","Encrypting Revenue Channel...","Bypassing Market Latency...","Syncing with o1 Reasoning Engine...","Protocol Phase 1: INITIALIZED","Protocol Phase 2: READY","ALL SYSTEMS GO."];y.forEach((u,T)=>{setTimeout(()=>{d(te=>[...te,`[${new Date().toLocaleTimeString()}] ${u}`]),T===y.length-1&&setTimeout(()=>{n(!1),a(!0),localStorage.setItem(`mission_${t}`,"active")},1e3)},T*600)})},b=y=>{const u=h.includes(y)?h.filter(T=>T!==y):[...h,y];g(u),localStorage.setItem(`checked_${t}`,JSON.stringify(u))};return i?e.jsxs("div",{className:"container mx-auto px-4 py-12 max-w-6xl relative",children:[s&&e.jsx("div",{className:"fixed inset-0 z-[100] bg-cyber-bg flex items-center justify-center p-6",children:e.jsxs("div",{className:"max-w-2xl w-full bg-black border border-cyber-primary/30 p-8 rounded-[32px] shadow-[0_0_100px_rgba(0,229,255,0.2)]",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-8 text-cyber-primary",children:[e.jsx(xe,{className:"w-6 h-6"}),e.jsx("h2",{className:"font-black uppercase tracking-[0.3em] text-sm",children:"System Intelligence Executive"})]}),e.jsxs("div",{className:"space-y-2 font-mono text-[10px] text-cyber-primary/80 mb-8 h-40 overflow-y-auto",children:[c.map((y,u)=>e.jsx("div",{className:"animate-fadeIn",children:y},u)),e.jsx("div",{className:"animate-pulse",children:"_"})]}),e.jsx("div",{className:"w-full bg-white/5 h-1 rounded-full overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyber-primary animate-[progressBar_4s_linear]"})})]})}),e.jsxs(r,{to:"/playbooks",className:"inline-flex items-center text-gray-500 hover:text-white mb-10 transition-colors text-[10px] font-black uppercase tracking-[0.2em]",children:[e.jsx(U,{className:"w-4 h-4 mr-2"})," Playbook Archives"]}),e.jsxs("header",{className:"mb-20",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-8",children:[e.jsx("span",{className:"bg-cyber-secondary text-white text-[9px] font-black px-5 py-2 rounded-sm uppercase tracking-[0.2em] italic",children:"Revenue Ops"}),e.jsxs("span",{className:"text-[9px] font-black text-gray-500 uppercase tracking-[0.2em] border border-white/10 px-5 py-2 rounded-sm",children:[i.difficulty," Execution"]}),o&&e.jsxs("span",{className:"bg-cyber-success/20 text-cyber-success text-[9px] font-black px-5 py-2 rounded-sm uppercase tracking-[0.2em] italic animate-pulse flex items-center gap-2",children:[e.jsx(x,{className:"w-3 h-3"})," Mission Active"]})]}),e.jsx("h1",{className:"text-5xl md:text-8xl font-black text-white mb-10 uppercase tracking-tighter leading-[0.8] italic",children:i.title}),e.jsx("p",{className:"text-2xl text-gray-400 font-light leading-relaxed max-w-4xl border-l-2 border-cyber-secondary pl-8",children:i.tldr})]}),e.jsxs("div",{className:"grid lg:grid-cols-[1fr_380px] gap-20",children:[e.jsxs("div",{className:"space-y-16",children:[e.jsx("div",{className:"w-full aspect-video rounded-[60px] overflow-hidden border border-white/5 bg-gray-900 shadow-2xl",children:e.jsx(P,{src:i.image||"",alt:i.title,className:"w-full h-full object-cover opacity-70",width:1200,height:675})}),e.jsx("div",{className:"prose prose-invert prose-xl max-w-none",children:e.jsx("div",{className:"article-content leading-relaxed space-y-12 text-gray-300 font-normal prose-h2:text-white prose-h2:font-black prose-h2:uppercase prose-h2:text-4xl prose-h3:text-cyber-secondary prose-h3:text-2xl",dangerouslySetInnerHTML:{__html:i.content||""}})})]}),e.jsx("aside",{className:"space-y-10",children:e.jsxs(m,{className:"border-cyber-secondary/20 bg-cyber-secondary/5 sticky top-32 p-10 rounded-[48px]",children:[e.jsxs("h3",{className:"font-black text-white mb-10 uppercase text-[10px] tracking-[0.3em] flex items-center gap-2",children:[e.jsx(F,{className:"text-cyber-secondary w-4 h-4"})," Intel Dashboard"]}),e.jsxs("div",{className:"space-y-10",children:[e.jsxs("div",{className:"group",children:[e.jsxs("div",{className:"flex items-center gap-2 text-cyber-secondary mb-3 font-black text-[9px] uppercase tracking-widest",children:[e.jsx(ve,{className:"w-4 h-4"})," Yield Potential"]}),e.jsx("p",{className:"text-4xl text-white font-black italic tracking-tighter group-hover:text-cyber-secondary transition-colors",children:i.roi})]}),e.jsx("div",{className:"h-px bg-white/10"}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2 text-gray-600 mb-3 font-black text-[9px] uppercase tracking-widest",children:[e.jsx(H,{className:"w-4 h-4"})," Execution Cycle"]}),e.jsx("p",{className:"text-3xl text-white font-black italic tracking-tighter",children:i.timeline})]}),e.jsx("div",{className:"h-px bg-white/10"}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-black text-white mb-6 uppercase text-[9px] tracking-[0.2em] italic",children:"Protocol Phases"}),e.jsx("ul",{className:"space-y-5",children:i.steps.map((y,u)=>e.jsxs("li",{onClick:()=>o&&b(u),className:`flex gap-4 text-xs font-bold group transition-all p-3 rounded-xl border border-transparent ${o?"cursor-pointer hover:bg-white/[0.03] hover:border-white/5":""} ${h.includes(u)?"opacity-30":"text-gray-400"}`,children:[o?e.jsx("div",{className:`w-5 h-5 border rounded flex-shrink-0 flex items-center justify-center transition-colors ${h.includes(u)?"bg-cyber-success border-cyber-success":"border-white/20"}`,children:h.includes(u)&&e.jsx(x,{className:"w-3.5 h-3.5 text-black"})}):e.jsxs("span",{className:"text-cyber-secondary font-black italic",children:["0",u+1]}),e.jsx("span",{className:`${o&&!h.includes(u)?"group-hover:text-white":""} ${h.includes(u)?"line-through":""}`,children:y})]},u))})]}),o?e.jsxs("div",{className:"space-y-4",children:[e.jsx("div",{className:"w-full bg-white/5 h-1.5 rounded-full overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyber-success transition-all duration-500",style:{width:`${h.length/i.steps.length*100}%`}})}),e.jsxs("p",{className:"text-[9px] font-black text-cyber-success uppercase text-center tracking-widest",children:["Mission Progress: ",Math.round(h.length/i.steps.length*100),"%"]}),e.jsx("button",{onClick:()=>{confirm("Reset Protocol?")&&(a(!1),g([]),localStorage.removeItem(`mission_${t}`),localStorage.removeItem(`checked_${t}`))},className:"w-full py-3 border border-white/5 text-gray-600 font-black uppercase text-[8px] tracking-widest rounded-xl hover:text-red-400 transition-all",children:"Abort Mission"})]}):e.jsxs("button",{onClick:p,className:"w-full py-5 bg-cyber-secondary text-white font-black uppercase text-[10px] tracking-widest rounded-2xl hover:brightness-110 transition-all shadow-xl flex items-center justify-center gap-2 group",children:[e.jsx(ke,{className:"w-4 h-4 group-hover:scale-110 transition-transform"})," Launch Protocol"]})]})]})})]})]}):e.jsx(j,{})},Ze=()=>{const{id:t}=M(),i=Ye.find(s=>s.id===t);return l.useEffect(()=>{window.scrollTo(0,0),i&&(document.title=`${i.title} | Crypto Intel`)},[t,i]),i?e.jsxs("div",{className:"container mx-auto px-4 py-12 max-w-4xl",children:[e.jsxs(r,{to:"/crypto",className:"inline-flex items-center text-gray-500 hover:text-white mb-10 transition-colors text-[10px] font-black uppercase tracking-[0.2em]",children:[e.jsx(U,{className:"w-4 h-4 mr-2"})," Asset Nexus"]}),e.jsxs("header",{className:"mb-20",children:[e.jsxs("div",{className:"inline-block px-6 py-2 bg-cyber-success/10 border border-cyber-success/20 text-cyber-success text-[9px] font-black uppercase tracking-[0.3em] rounded-sm mb-10 italic",children:["THREAT LEVEL: ",i.level]}),e.jsx("h1",{className:"text-5xl md:text-8xl font-black text-white mb-10 uppercase tracking-tighter leading-[0.85] italic text-balance",children:i.title}),e.jsx("p",{className:"text-2xl text-gray-400 font-light leading-relaxed max-w-3xl",children:i.summary})]}),e.jsx("div",{className:"prose prose-invert prose-xl max-w-none",children:e.jsx("div",{className:"article-content leading-[1.8] space-y-12 text-gray-300 font-normal prose-h2:text-white prose-h2:font-black prose-h2:uppercase",dangerouslySetInnerHTML:{__html:i.content}})}),e.jsxs("div",{className:"mt-24 p-12 border border-cyber-success/20 rounded-[48px] bg-cyber-success/5 flex flex-col md:flex-row gap-10 items-center group",children:[e.jsx("div",{className:"w-20 h-20 rounded-[28px] bg-cyber-success/20 flex items-center justify-center flex-shrink-0 border border-cyber-success/30 group-hover:scale-110 transition-transform",children:e.jsx(we,{className:"text-cyber-success w-10 h-10"})}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-white font-black uppercase tracking-[0.2em] text-lg mb-3 italic",children:"Custody Verification Protocol"}),e.jsx("p",{className:"text-sm text-gray-500 leading-relaxed font-light",children:"This technical documentation was reviewed by blockchain security auditors. Remember: in Web3, security is an individual responsibility. Never share your Private Keys or Seed Phrases with third parties."})]})]})]}):e.jsx(j,{})},Z=()=>{l.useEffect(()=>{document.title="About Us | Open Your AIs"},[]);const t={"@context":"https://schema.org","@type":"AboutPage",name:"About Open Your AIs",description:"Learn about Open Your AIs - a technology intelligence platform covering AI, cryptocurrency, and digital monetization strategies.",url:"https://www.openyourais.com/about",mainEntity:{"@type":"Organization",name:"Open Your AIs",url:"https://www.openyourais.com",email:w,description:"Open Your AIs is a technology intelligence platform providing expert analysis on artificial intelligence, cryptocurrency, and digital monetization.",foundingDate:"2025",sameAs:[]}},i={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://www.openyourais.com/"},{"@type":"ListItem",position:2,name:"About Us",item:"https://www.openyourais.com/about"}]};return e.jsxs("div",{className:"container mx-auto px-4 py-20 max-w-5xl",children:[e.jsxs(I,{children:[e.jsx("title",{children:"About Us | Open Your AIs"}),e.jsx("meta",{name:"description",content:"Learn about Open Your AIs - a technology intelligence platform providing expert analysis on AI tools, cryptocurrency strategies, and digital monetization playbooks."}),e.jsx("link",{rel:"canonical",href:"https://www.openyourais.com/about"}),e.jsx("meta",{property:"og:title",content:"About Us | Open Your AIs"}),e.jsx("meta",{property:"og:description",content:"Learn about Open Your AIs - a technology intelligence platform covering AI, cryptocurrency, and digital monetization."}),e.jsx("meta",{property:"og:type",content:"website"}),e.jsx("meta",{property:"og:url",content:"https://www.openyourais.com/about"}),e.jsx("meta",{name:"twitter:title",content:"About Us | Open Your AIs"}),e.jsx("meta",{name:"twitter:description",content:"Learn about Open Your AIs - a technology intelligence platform covering AI, cryptocurrency, and digital monetization."}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(t)}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(i)})]}),e.jsx("nav",{"aria-label":"Breadcrumb",className:"mb-8",children:e.jsxs("ol",{className:"flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("li",{children:e.jsx(r,{to:"/",className:"hover:text-white transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(v,{className:"w-3 h-3"})}),e.jsx("li",{className:"text-cyber-primary","aria-current":"page",children:"About Us"})]})}),e.jsx(A,{title:"About Open Your AIs",subtitle:"Where 14 years of professional filmmaking meets the AI revolution."}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-20 items-center mb-24",children:[e.jsxs("div",{className:"relative group",children:[e.jsx("div",{className:"absolute -inset-10 bg-cyber-primary/10 blur-[100px] rounded-full group-hover:bg-cyber-primary/20 transition-all duration-1000"}),e.jsx(P,{src:"https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=800&q=80",alt:"Open Your AIs - Where filmmaking meets AI",className:"rounded-[60px] border border-white/5 relative z-10 shadow-2xl grayscale hover:grayscale-0 transition-all duration-700",width:600,height:400})]}),e.jsxs("div",{className:"space-y-10",children:[e.jsx("h2",{className:"text-4xl font-black text-white uppercase tracking-tighter italic",children:"The Person Behind This"}),e.jsxs("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:["I'm ",e.jsx("strong",{className:"text-white",children:"Ulisses Balbino"}),". Since 2012, I've directed and produced commercial work for brands like ",e.jsx("strong",{className:"text-white",children:"Disney, Starbucks, Nestlé, Yamaha, Carrefour, Kopenhagen, and Benefit"})," through my production company, Pichorra Filmes."]}),e.jsxs("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:["I'm also a comedy writer and performer — I wrote and acted in sketches for Ronald Rios' talk show on ",e.jsx("strong",{className:"text-white",children:"Paramount, Comedy Central, and MTV"}),". Before that, I hosted a humor show on Jovem Pan, one of Brazil's biggest radio networks. I compose music, I act, I edit, I direct. I've done every job on a set."]}),e.jsxs("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:["Now I use AI in my production work — not to replace any of that knowledge, but to ",e.jsx("strong",{className:"text-white",children:"amplify all of it"}),"."]})]})]}),e.jsxs("div",{className:"mb-24",children:[e.jsx("h2",{className:"text-3xl font-black text-white uppercase tracking-tighter italic mb-12 text-center",children:"Why This Site Exists"}),e.jsxs("div",{className:"max-w-3xl mx-auto space-y-6",children:[e.jsx("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:"In 2015, I produced a 30-second commercial for Nestlé. Budget: $47,000. Crew of 28 people, two shoot days, a week of post-production. Last month, I recreated a similar shot with AI tools in 20 minutes for about $3 in API credits."}),e.jsx("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:"The AI version looked technically impressive but emotionally flat. No soul. No tension. No happy accident. That's the story of AI in creative production right now — and that's exactly what I write about here."}),e.jsxs("p",{className:"text-gray-400 leading-relaxed text-lg font-light",children:["Open Your AIs isn't another tech blog regurgitating press releases. It's the perspective of someone who's been in the trenches of professional production for 14 years and now works at the intersection of ",e.jsx("strong",{className:"text-white",children:"human creativity and artificial intelligence"}),". Every review, every analysis, every opinion comes from real experience — not theory."]})]})]}),e.jsxs("div",{className:"mb-24",children:[e.jsx("h2",{className:"text-3xl font-black text-white uppercase tracking-tighter italic mb-12 text-center",children:"What We Cover"}),e.jsxs("div",{className:"grid md:grid-cols-3 gap-8",children:[e.jsxs(m,{className:"text-center p-10",children:[e.jsx("div",{className:"w-16 h-16 mx-auto bg-cyber-primary/10 rounded-2xl flex items-center justify-center mb-6 text-cyber-primary border border-cyber-primary/20",children:e.jsx(F,{className:"w-8 h-8"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-4 uppercase",children:"AI in Production"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Honest reviews of AI tools from a working director's perspective. What actually works in professional workflows — and what's just demo reel material."})]}),e.jsxs(m,{className:"text-center p-10",children:[e.jsx("div",{className:"w-16 h-16 mx-auto bg-cyber-success/10 rounded-2xl flex items-center justify-center mb-6 text-cyber-success border border-cyber-success/20",children:e.jsx(ge,{className:"w-8 h-8"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-4 uppercase",children:"The Hybrid Creator"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"How creative professionals are adapting to AI. What changes, what doesn't, and why human experience is more valuable than ever."})]}),e.jsxs(m,{className:"text-center p-10",children:[e.jsx("div",{className:"w-16 h-16 mx-auto bg-cyber-secondary/10 rounded-2xl flex items-center justify-center mb-6 text-cyber-secondary border border-cyber-secondary/20",children:e.jsx(Y,{className:"w-8 h-8"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-4 uppercase",children:"Monetization & Tech"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Real strategies for building income with AI and technology. No fake promises — just honest playbooks from someone figuring it out in public."})]})]})]}),e.jsxs("div",{className:"mb-24",children:[e.jsx("h2",{className:"text-3xl font-black text-white uppercase tracking-tighter italic mb-12 text-center",children:"Our Philosophy"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-8 max-w-4xl mx-auto",children:[e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5",children:[e.jsx("h3",{className:"text-lg font-black text-cyber-primary mb-3 uppercase",children:"AI Amplifies, Doesn't Replace"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"14 years of directing taught me that creative judgment can't be automated. AI handles the heavy lifting; humans make the decisions that matter."})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5",children:[e.jsx("h3",{className:"text-lg font-black text-cyber-primary mb-3 uppercase",children:"Honest Reviews Only"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"If a tool is impressive, I'll say so. If it's overhyped, I'll say that too. Every review comes from actual professional use, not press releases."})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5",children:[e.jsx("h3",{className:"text-lg font-black text-cyber-primary mb-3 uppercase",children:"Experience Over Theory"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"I've directed for Disney and Starbucks. I've written comedy for MTV. I edit, grade, and deliver. When I review AI tools, it's from inside the craft."})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5",children:[e.jsx("h3",{className:"text-lg font-black text-cyber-primary mb-3 uppercase",children:"The Hybrid Future"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"The future isn't AI vs. Human. It's Human + AI vs. Everyone Else. We document that future from the front lines."})]})]})]}),e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-8 mb-24",children:[e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5 text-center",children:[e.jsx("p",{className:"text-cyber-primary font-black text-4xl mb-2 italic",children:"14+"}),e.jsx("p",{className:"text-[9px] text-gray-500 uppercase font-black tracking-[0.3em]",children:"Years in Production"})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5 text-center",children:[e.jsx("p",{className:"text-cyber-secondary font-black text-4xl mb-2 italic",children:"50+"}),e.jsx("p",{className:"text-[9px] text-gray-500 uppercase font-black tracking-[0.3em]",children:"Articles Published"})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5 text-center",children:[e.jsx("p",{className:"text-cyber-success font-black text-4xl mb-2 italic",children:"10+"}),e.jsx("p",{className:"text-[9px] text-gray-500 uppercase font-black tracking-[0.3em]",children:"AI Tools Tested"})]}),e.jsxs("div",{className:"p-8 bg-white/[0.02] rounded-[32px] border border-white/5 text-center",children:[e.jsx("p",{className:"text-white font-black text-4xl mb-2 italic",children:"100%"}),e.jsx("p",{className:"text-[9px] text-gray-500 uppercase font-black tracking-[0.3em]",children:"Real Experience"})]})]}),e.jsxs("div",{className:"text-center p-12 bg-gradient-to-br from-cyber-primary/10 to-transparent border border-cyber-primary/20 rounded-[48px]",children:[e.jsx("h2",{className:"text-2xl font-black text-white mb-4 uppercase",children:"Get in Touch"}),e.jsx("p",{className:"text-gray-400 mb-8 max-w-xl mx-auto",children:"Have questions, feedback, or partnership inquiries? We'd love to hear from you."}),e.jsxs(r,{to:"/contact",className:"inline-flex items-center gap-2 px-10 py-4 bg-cyber-primary text-cyber-bg font-black rounded-full hover:shadow-[0_0_25px_rgba(0,229,255,0.5)] transition-all uppercase tracking-widest text-xs",children:[e.jsx(E,{className:"w-4 h-4"})," Contact Us"]})]})]})},ee=()=>{const[t,i]=l.useState({name:"",email:"",subject:"",message:""}),[s,n]=l.useState(!1);l.useEffect(()=>{document.title="Contact Us | Open Your AIs"},[]);const o=d=>{d.preventDefault();const h=`mailto:${w}?subject=${encodeURIComponent(t.subject||"Contact from OpenYourAIs.com")}&body=${encodeURIComponent(`Name: ${t.name}
Email: ${t.email}

${t.message}`)}`;window.location.href=h,n(!0)},a={"@context":"https://schema.org","@type":"ContactPage",name:"Contact Open Your AIs",description:"Get in touch with the Open Your AIs team for questions, feedback, or partnership inquiries.",url:"https://www.openyourais.com/contact",mainEntity:{"@type":"Organization",name:"Open Your AIs",email:w,url:"https://www.openyourais.com"}},c={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://www.openyourais.com/"},{"@type":"ListItem",position:2,name:"Contact",item:"https://www.openyourais.com/contact"}]};return e.jsxs("div",{className:"container mx-auto px-4 py-20 max-w-4xl",children:[e.jsxs(I,{children:[e.jsx("title",{children:"Contact Us | Open Your AIs"}),e.jsx("meta",{name:"description",content:"Contact the Open Your AIs team. Send us your questions, feedback, or partnership inquiries about AI, cryptocurrency, and digital monetization."}),e.jsx("link",{rel:"canonical",href:"https://www.openyourais.com/contact"}),e.jsx("meta",{property:"og:title",content:"Contact Us | Open Your AIs"}),e.jsx("meta",{property:"og:description",content:"Get in touch with the Open Your AIs team for questions, feedback, or partnership inquiries."}),e.jsx("meta",{property:"og:type",content:"website"}),e.jsx("meta",{property:"og:url",content:"https://www.openyourais.com/contact"}),e.jsx("meta",{name:"twitter:title",content:"Contact Us | Open Your AIs"}),e.jsx("meta",{name:"twitter:description",content:"Get in touch with the Open Your AIs team."}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(a)}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(c)})]}),e.jsx("nav",{"aria-label":"Breadcrumb",className:"mb-8",children:e.jsxs("ol",{className:"flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("li",{children:e.jsx(r,{to:"/",className:"hover:text-white transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(v,{className:"w-3 h-3"})}),e.jsx("li",{className:"text-cyber-primary","aria-current":"page",children:"Contact"})]})}),e.jsx(A,{title:"Contact Us",subtitle:"Have questions, feedback, or partnership inquiries? We'd love to hear from you."}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-12",children:[e.jsx(m,{className:"p-10 rounded-[48px]",children:s?e.jsxs("div",{className:"text-center py-12",children:[e.jsx("div",{className:"w-16 h-16 mx-auto bg-cyber-success/10 rounded-2xl flex items-center justify-center mb-6 text-cyber-success border border-cyber-success/20",children:e.jsx(x,{className:"w-8 h-8"})}),e.jsx("h3",{className:"text-xl font-black text-white mb-4 uppercase",children:"Message Sent"}),e.jsxs("p",{className:"text-gray-400 text-sm",children:["Your email client should have opened with the message. If not, please email us directly at ",e.jsx("a",{href:`mailto:${w}`,className:"text-cyber-primary hover:underline",children:w}),"."]}),e.jsx("button",{onClick:()=>{n(!1),i({name:"",email:"",subject:"",message:""})},className:"mt-8 px-8 py-3 border border-white/10 text-white font-black rounded-xl text-[10px] uppercase tracking-widest hover:bg-white/5 transition-all",children:"Send Another Message"})]}):e.jsxs("form",{onSubmit:o,className:"space-y-6",children:[e.jsx("h2",{className:"text-xl font-black text-white uppercase tracking-widest mb-6",children:"Send a Message"}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"contact-name",className:"block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2",children:"Your Name *"}),e.jsx("input",{id:"contact-name",type:"text",required:!0,value:t.name,onChange:d=>i({...t,name:d.target.value}),className:"w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-cyber-primary transition-all",placeholder:"John Doe"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"contact-email",className:"block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2",children:"Your Email *"}),e.jsx("input",{id:"contact-email",type:"email",required:!0,value:t.email,onChange:d=>i({...t,email:d.target.value}),className:"w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-cyber-primary transition-all",placeholder:"john@example.com"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"contact-subject",className:"block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2",children:"Subject"}),e.jsx("input",{id:"contact-subject",type:"text",value:t.subject,onChange:d=>i({...t,subject:d.target.value}),className:"w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-cyber-primary transition-all",placeholder:"General Inquiry"})]}),e.jsxs("div",{children:[e.jsx("label",{htmlFor:"contact-message",className:"block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2",children:"Message *"}),e.jsx("textarea",{id:"contact-message",required:!0,rows:5,value:t.message,onChange:d=>i({...t,message:d.target.value}),className:"w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:border-cyber-primary transition-all resize-none",placeholder:"Your message..."})]}),e.jsxs("button",{type:"submit",className:"w-full py-4 bg-cyber-primary text-cyber-bg font-black rounded-xl uppercase tracking-widest text-xs hover:shadow-[0_0_25px_rgba(0,229,255,0.5)] transition-all flex items-center justify-center gap-2",children:[e.jsx(E,{className:"w-4 h-4"})," Send Message"]})]})}),e.jsxs("div",{className:"space-y-8",children:[e.jsxs(m,{className:"p-8 rounded-[32px]",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-cyber-primary/10 rounded-xl flex items-center justify-center text-cyber-primary border border-cyber-primary/20",children:e.jsx(E,{className:"w-6 h-6"})}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-white font-black uppercase text-sm",children:"Email"}),e.jsx("a",{href:`mailto:${w}`,className:"text-cyber-primary text-sm hover:underline",children:w})]})]}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"For general inquiries, feedback, corrections, or partnership proposals. We typically respond within 24-48 hours."})]}),e.jsxs(m,{className:"p-8 rounded-[32px]",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[e.jsx("div",{className:"w-12 h-12 bg-cyber-secondary/10 rounded-xl flex items-center justify-center text-cyber-secondary border border-cyber-secondary/20",children:e.jsx(be,{className:"w-6 h-6"})}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-white font-black uppercase text-sm",children:"Website"}),e.jsx("span",{className:"text-cyber-secondary text-sm",children:"www.openyourais.com"})]})]}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Browse our full library of AI tools, monetization playbooks, crypto guides, and technology articles."})]}),e.jsxs(m,{className:"p-8 rounded-[32px]",children:[e.jsx("h3",{className:"text-white font-black uppercase text-sm mb-4",children:"Common Inquiries"}),e.jsxs("ul",{className:"space-y-3 text-gray-400 text-sm",children:[e.jsxs("li",{className:"flex items-start gap-2",children:[e.jsx(x,{className:"w-4 h-4 text-cyber-success mt-0.5 flex-shrink-0"})," Content corrections or updates"]}),e.jsxs("li",{className:"flex items-start gap-2",children:[e.jsx(x,{className:"w-4 h-4 text-cyber-success mt-0.5 flex-shrink-0"})," Advertising and sponsorship inquiries"]}),e.jsxs("li",{className:"flex items-start gap-2",children:[e.jsx(x,{className:"w-4 h-4 text-cyber-success mt-0.5 flex-shrink-0"})," Guest post and collaboration proposals"]}),e.jsxs("li",{className:"flex items-start gap-2",children:[e.jsx(x,{className:"w-4 h-4 text-cyber-success mt-0.5 flex-shrink-0"})," Technical feedback and suggestions"]}),e.jsxs("li",{className:"flex items-start gap-2",children:[e.jsx(x,{className:"w-4 h-4 text-cyber-success mt-0.5 flex-shrink-0"})," Privacy and data-related requests"]})]})]})]})]}),e.jsxs(m,{className:"p-12 md:p-16 rounded-[48px] border-white/5 bg-white/[0.01] mb-20",children:[e.jsx("h3",{className:"text-3xl font-black text-white uppercase tracking-widest mb-8",children:"Our Mission"}),e.jsxs("div",{className:"space-y-6 text-gray-400 leading-relaxed",children:[e.jsx("p",{className:"text-lg",children:"In an era where artificial intelligence evolves faster than traditional education can adapt, we serve as your technical translator and strategic partner. Our mission is threefold:"}),e.jsxs("ul",{className:"space-y-4 ml-6",children:[e.jsxs("li",{className:"flex items-start gap-3",children:[e.jsx("span",{className:"text-cyber-primary font-black",children:"01."}),e.jsxs("span",{children:[e.jsx("strong",{className:"text-white",children:"Decode Complexity:"})," Transform cutting-edge AI developments, blockchain protocols, and automation frameworks into understandable, actionable intelligence."]})]}),e.jsxs("li",{className:"flex items-start gap-3",children:[e.jsx("span",{className:"text-cyber-secondary font-black",children:"02."}),e.jsxs("span",{children:[e.jsx("strong",{className:"text-white",children:"Verify Accuracy:"})," Every piece of content undergoes rigorous fact-checking against primary sources, technical documentation, and real-world testing."]})]}),e.jsxs("li",{className:"flex items-start gap-3",children:[e.jsx("span",{className:"text-cyber-success font-black",children:"03."}),e.jsxs("span",{children:[e.jsx("strong",{className:"text-white",children:"Enable Sovereignty:"})," Provide the knowledge and tools necessary for digital independenceâ€”whether through AI-powered workflows, decentralized finance, or automated revenue systems."]})]})]})]})]}),e.jsxs("div",{className:"grid md:grid-cols-3 gap-8 mb-20",children:[e.jsxs(m,{className:"p-10 text-center border-b-4 border-b-cyber-primary",children:[e.jsx("h4",{className:"text-xl font-black text-white uppercase tracking-widest mb-4",children:"AI Intelligence"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Deep technical analysis of Large Language Models, generative AI tools, and autonomous agent frameworks. From GPT-4 to Claude, from Midjourney to Runwayâ€”we test, compare, and explain."})]}),e.jsxs(m,{className:"p-10 text-center border-b-4 border-b-cyber-secondary",children:[e.jsx("h4",{className:"text-xl font-black text-white uppercase tracking-widest mb-4",children:"Digital Capital"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Battle-tested monetization playbooks leveraging automation and AI. Not theoryâ€”practical frameworks with verified ROI, timeline estimates, and step-by-step execution guides."})]}),e.jsxs(m,{className:"p-10 text-center border-b-4 border-b-cyber-success",children:[e.jsx("h4",{className:"text-xl font-black text-white uppercase tracking-widest mb-4",children:"Web3 Security"}),e.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Security-first documentation for digital asset self-custody, DeFi protocols, and blockchain fundamentals. Protecting your capital in the decentralized economy."})]})]}),e.jsxs(m,{className:"p-12 md:p-16 rounded-[48px] border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent",children:[e.jsx("h3",{className:"text-3xl font-black text-white uppercase tracking-widest mb-8",children:"Editorial Standards"}),e.jsxs("div",{className:"grid md:grid-cols-2 gap-12",children:[e.jsxs("div",{children:[e.jsx("h4",{className:"text-cyber-primary font-black uppercase tracking-widest mb-4 text-sm",children:"Verification Protocol"}),e.jsx("p",{className:"text-gray-400 leading-relaxed mb-6",children:"Every article, playbook, and guide published on Open Your AIs undergoes a multi-stage verification process. We cross-reference technical claims against official documentation, test tools and strategies where possible, and clearly distinguish between verified facts and analytical projections."}),e.jsx("h4",{className:"text-cyber-secondary font-black uppercase tracking-widest mb-4 text-sm",children:"Transparency"}),e.jsx("p",{className:"text-gray-400 leading-relaxed",children:"We disclose affiliate relationships where they exist, clearly label sponsored content, and maintain editorial independence. Our recommendations are based on merit and testing, not compensation."})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"text-cyber-success font-black uppercase tracking-widest mb-4 text-sm",children:"Continuous Updates"}),e.jsx("p",{className:"text-gray-400 leading-relaxed mb-6",children:"Technology moves fast. We regularly update our content to reflect new developments, deprecated features, and evolving best practices. Each article includes a last-updated timestamp for transparency."}),e.jsx("h4",{className:"text-white font-black uppercase tracking-widest mb-4 text-sm",children:"Community Feedback"}),e.jsx("p",{className:"text-gray-400 leading-relaxed",children:"We actively engage with our community through comments, social media, and direct email. Reader corrections and suggestions are not just welcomedâ€”they're essential to maintaining accuracy in a rapidly changing field."})]})]})]}),e.jsxs("div",{className:"text-center mt-20",children:[e.jsx("h3",{className:"text-2xl font-black text-white uppercase tracking-widest mb-6",children:"Connect With Us"}),e.jsx("p",{className:"text-gray-400 mb-8 max-w-2xl mx-auto",children:"Have questions, suggestions, or corrections? We believe in open dialogue with our community. Reach out through our contact page or connect on social media."}),e.jsx(r,{to:"/contact",className:"inline-block px-12 py-4 bg-cyber-primary text-cyber-bg font-black rounded-full hover:shadow-[0_0_30px_rgba(0,229,255,0.4)] transition-all uppercase tracking-widest text-sm",children:"Contact Us"})]})]})},R=({type:t})=>{l.useEffect(()=>{document.title=t==="privacy"?"Privacy Policy | Open Your AIs":"Terms of Service | Open Your AIs"},[t]);const i=t==="privacy"?"Privacy Policy":"Terms of Service",s=t==="privacy"?"https://www.openyourais.com/privacy":"https://www.openyourais.com/terms",n=t==="privacy"?"Read the Open Your AIs Privacy Policy. Learn how we collect, use, and protect your personal information when you visit our website.":"Read the Open Your AIs Terms of Service. Understand the rules and guidelines for using our website and content.",o={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://www.openyourais.com/"},{"@type":"ListItem",position:2,name:i,item:s}]};return e.jsxs("div",{className:"container mx-auto px-4 py-20 max-w-4xl",children:[e.jsxs(I,{children:[e.jsxs("title",{children:[i," | Open Your AIs"]}),e.jsx("meta",{name:"description",content:n}),e.jsx("link",{rel:"canonical",href:s}),e.jsx("meta",{property:"og:title",content:`${i} | Open Your AIs`}),e.jsx("meta",{property:"og:description",content:n}),e.jsx("meta",{property:"og:type",content:"website"}),e.jsx("meta",{property:"og:url",content:s}),e.jsx("meta",{name:"twitter:title",content:`${i} | Open Your AIs`}),e.jsx("meta",{name:"twitter:description",content:n}),e.jsx("script",{type:"application/ld+json",children:JSON.stringify(o)})]}),e.jsx("nav",{"aria-label":"Breadcrumb",className:"mb-8",children:e.jsxs("ol",{className:"flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-500",children:[e.jsx("li",{children:e.jsx(r,{to:"/",className:"hover:text-white transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(v,{className:"w-3 h-3"})}),e.jsx("li",{className:"text-cyber-primary","aria-current":"page",children:i})]})}),e.jsx(A,{title:i}),e.jsx(m,{className:"p-10 md:p-16 rounded-[48px] border-white/5 bg-white/[0.01]",children:e.jsxs("div",{className:"prose prose-invert max-w-none text-gray-400 font-light",children:[e.jsx("p",{className:"text-cyber-primary font-black uppercase tracking-[0.3em] text-[10px] mb-16 italic underline decoration-cyber-primary/30 underline-offset-8",children:"Last Updated: February 19, 2026"}),t==="privacy"?e.jsxs("div",{className:"space-y-12",children:[e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"1. Introduction"}),e.jsxs("p",{className:"leading-relaxed",children:['Open Your AIs ("we," "our," or "us") operates the website ',e.jsx("a",{href:"https://www.openyourais.com",className:"text-cyber-primary hover:underline",children:"www.openyourais.com"}),' (the "Service"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this policy carefully. By using the Service, you agree to the collection and use of information in accordance with this policy.']})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"2. Information We Collect"}),e.jsx("h3",{className:"text-gray-200 font-bold text-lg mb-3",children:"2.1 Automatically Collected Information"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"When you visit our website, we may automatically collect certain information about your device, including your IP address, browser type, operating system, referring URLs, and pages visited. This data is collected through Google Analytics (GA4) to help us understand how visitors use our site and improve our content."}),e.jsx("h3",{className:"text-gray-200 font-bold text-lg mb-3",children:"2.2 Cookies and Tracking Technologies"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"We use cookies and similar tracking technologies to track activity on our Service. Cookies are files with a small amount of data that may include an anonymous unique identifier. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent."}),e.jsx("h3",{className:"text-gray-200 font-bold text-lg mb-3",children:"2.3 Newsletter Subscription"}),e.jsx("p",{className:"leading-relaxed",children:"If you subscribe to our newsletter, we collect your email address. This information is used solely to send you our newsletter and will not be shared with third parties."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"3. How We Use Your Information"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"We use the information we collect to:"}),e.jsxs("ul",{className:"list-disc pl-6 space-y-2 leading-relaxed",children:[e.jsx("li",{children:"Operate, maintain, and improve our website"}),e.jsx("li",{children:"Understand and analyze usage trends and preferences"}),e.jsx("li",{children:"Send newsletters and updates (with your consent)"}),e.jsx("li",{children:"Display relevant advertisements through Google AdSense"}),e.jsx("li",{children:"Monitor and analyze the effectiveness of our content"}),e.jsx("li",{children:"Detect, prevent, and address technical issues"})]})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"4. Google AdSense & Advertising"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"We use Google AdSense to display advertisements on our website. Google AdSense uses cookies to serve ads based on your prior visits to our website or other websites. Google's use of advertising cookies enables it and its partners to serve ads based on your visit to our site and/or other sites on the Internet."}),e.jsxs("p",{className:"leading-relaxed",children:["You may opt out of personalized advertising by visiting ",e.jsx("a",{href:"https://www.google.com/settings/ads",className:"text-cyber-primary hover:underline",target:"_blank",rel:"noopener noreferrer",children:"Google Ads Settings"}),". Alternatively, you can opt out of third-party vendor cookies by visiting the ",e.jsx("a",{href:"https://www.aboutads.info/choices/",className:"text-cyber-primary hover:underline",target:"_blank",rel:"noopener noreferrer",children:"Digital Advertising Alliance opt-out page"}),"."]})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"5. Google Analytics"}),e.jsx("p",{className:"leading-relaxed",children:"We use Google Analytics 4 (GA4) to monitor and analyze web traffic. Google Analytics collects data such as how often users visit the site, what pages they visit, and what other sites they used prior to coming to our site. We use this information to improve our Service. Google Analytics collects only the IP address assigned to you on the date you visit our site, rather than your name or other identifying information."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"6. Third-Party Links"}),e.jsx("p",{className:"leading-relaxed",children:"Our website may contain links to third-party websites, including affiliate links. We are not responsible for the privacy practices or content of these third-party sites. We encourage you to read the privacy policies of any third-party site you visit."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"7. Data Security"}),e.jsx("p",{className:"leading-relaxed",children:"We implement appropriate technical and organizational security measures to protect your personal information. However, no method of transmission over the Internet or electronic storage is 100% secure, and we cannot guarantee absolute security."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"8. Children's Privacy"}),e.jsx("p",{className:"leading-relaxed",children:"Our Service is not directed to anyone under the age of 13. We do not knowingly collect personally identifiable information from children under 13. If we discover that a child under 13 has provided us with personal information, we will delete it immediately."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"9. Your Rights"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"Depending on your location, you may have the following rights regarding your personal data:"}),e.jsxs("ul",{className:"list-disc pl-6 space-y-2 leading-relaxed",children:[e.jsx("li",{children:"The right to access the personal data we hold about you"}),e.jsx("li",{children:"The right to request correction of inaccurate data"}),e.jsx("li",{children:"The right to request deletion of your data"}),e.jsx("li",{children:"The right to opt out of marketing communications"}),e.jsx("li",{children:"The right to lodge a complaint with a supervisory authority"})]})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"10. Changes to This Policy"}),e.jsx("p",{className:"leading-relaxed",children:'We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last Updated" date. You are advised to review this Privacy Policy periodically for any changes.'})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"11. Contact Us"}),e.jsxs("p",{className:"leading-relaxed",children:["If you have any questions about this Privacy Policy, please contact us at: ",e.jsx("a",{href:`mailto:${w}`,className:"text-cyber-primary hover:underline",children:w})]})]})]}):e.jsxs("div",{className:"space-y-12",children:[e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"1. Acceptance of Terms"}),e.jsxs("p",{className:"leading-relaxed",children:["By accessing and using Open Your AIs (",e.jsx("a",{href:"https://www.openyourais.com",className:"text-cyber-primary hover:underline",children:"www.openyourais.com"}),"), you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our website."]})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"2. Description of Service"}),e.jsx("p",{className:"leading-relaxed",children:"Open Your AIs is a technology intelligence platform that provides educational content about artificial intelligence, cryptocurrency, blockchain technology, and digital monetization strategies. Our content includes articles, tool reviews, playbooks, and guides."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"3. Educational Disclaimer"}),e.jsxs("p",{className:"leading-relaxed mb-4",children:["All information provided on Open Your AIs is for ",e.jsx("strong",{className:"text-white",children:"educational and informational purposes only"}),". We are not financial advisors, investment advisors, or legal professionals. The content on this website should not be construed as:"]}),e.jsxs("ul",{className:"list-disc pl-6 space-y-2 leading-relaxed",children:[e.jsx("li",{children:"Financial advice or investment recommendations"}),e.jsx("li",{children:"Legal or tax advice"}),e.jsx("li",{children:"A guarantee of any specific results or outcomes"}),e.jsx("li",{children:"An endorsement of any specific product, service, or investment"})]}),e.jsx("p",{className:"leading-relaxed mt-4",children:"Cryptocurrency investments and AI-based business ventures involve significant risk. Always conduct your own research and consult with qualified professionals before making financial decisions."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"4. Intellectual Property"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"All content on Open Your AIs, including but not limited to text, graphics, logos, images, and software, is the property of Open Your AIs and is protected by intellectual property laws. You may:"}),e.jsxs("ul",{className:"list-disc pl-6 space-y-2 leading-relaxed",children:[e.jsx("li",{children:"View and read content for personal, non-commercial use"}),e.jsx("li",{children:"Share links to our content on social media"}),e.jsx("li",{children:"Quote brief excerpts with proper attribution and a link back to the original article"})]}),e.jsx("p",{className:"leading-relaxed mt-4",children:"You may not reproduce, distribute, modify, or create derivative works from our content without prior written permission."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"5. User Conduct"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"When using our website, you agree not to:"}),e.jsxs("ul",{className:"list-disc pl-6 space-y-2 leading-relaxed",children:[e.jsx("li",{children:"Use the Service for any unlawful purpose"}),e.jsx("li",{children:"Attempt to gain unauthorized access to any part of the Service"}),e.jsx("li",{children:"Interfere with or disrupt the Service or servers"}),e.jsx("li",{children:"Scrape, crawl, or use automated means to access the Service without permission"}),e.jsx("li",{children:"Transmit any viruses, malware, or harmful code"})]})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"6. Third-Party Links & Affiliate Disclosure"}),e.jsx("p",{className:"leading-relaxed mb-4",children:"Our website may contain links to third-party websites and services. Some of these links may be affiliate links, meaning we may earn a commission if you make a purchase through them, at no additional cost to you."}),e.jsx("p",{className:"leading-relaxed",children:"We are not responsible for the content, privacy policies, or practices of any third-party websites. We encourage you to review the terms and privacy policies of any third-party site you visit."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"7. Limitation of Liability"}),e.jsx("p",{className:"leading-relaxed",children:"To the fullest extent permitted by applicable law, Open Your AIs shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or other intangible losses, resulting from your use of or inability to use the Service."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"8. Accuracy of Information"}),e.jsx("p",{className:"leading-relaxed",children:"While we strive to provide accurate and up-to-date information, we make no warranties or representations about the accuracy, reliability, or completeness of any content on our website. Technology and market conditions change rapidly, and information may become outdated. We encourage users to verify information independently."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"9. Modifications to Terms"}),e.jsx("p",{className:"leading-relaxed",children:"We reserve the right to modify these Terms of Service at any time. Changes will be effective immediately upon posting on this page. Your continued use of the Service after any changes constitutes acceptance of the new terms."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"10. Governing Law"}),e.jsx("p",{className:"leading-relaxed",children:"These Terms shall be governed by and construed in accordance with applicable laws, without regard to conflict of law principles."})]}),e.jsxs("section",{children:[e.jsx("h2",{className:"text-white font-black text-2xl uppercase tracking-widest mb-6",children:"11. Contact Us"}),e.jsxs("p",{className:"leading-relaxed",children:["If you have any questions about these Terms of Service, please contact us at: ",e.jsx("a",{href:`mailto:${w}`,className:"text-cyber-primary hover:underline",children:w})]})]})]})]})})]})},D=Object.freeze(Object.defineProperty({__proto__:null,AboutPage:Z,ArticleReader:Je,ContactPage:ee,CryptoReader:Ze,LegalPage:R,NotFoundPage:j,PlaybookReader:Xe,SitemapPage:X},Symbol.toStringTag,{value:"Module"})),et=l.lazy(()=>k(()=>import("./ContentPages-ChNdqzJb.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>({default:t.ToolsPage}))),tt=l.lazy(()=>k(()=>import("./ContentPages-ChNdqzJb.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>({default:t.PlaybooksPage}))),it=l.lazy(()=>k(()=>import("./ContentPages-ChNdqzJb.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>({default:t.CryptoPage}))),at=l.lazy(()=>k(()=>import("./ContentPages-ChNdqzJb.js"),__vite__mapDeps([0,1,2,3,4])).then(t=>({default:t.BlogPage}))),st=l.lazy(()=>k(()=>Promise.resolve().then(()=>D),void 0).then(t=>({default:t.ArticleReader}))),ot=l.lazy(()=>k(()=>Promise.resolve().then(()=>D),void 0).then(t=>({default:t.PlaybookReader}))),nt=l.lazy(()=>k(()=>Promise.resolve().then(()=>D),void 0).then(t=>({default:t.CryptoReader}))),rt=l.lazy(()=>k(()=>import("./Admin-DFKnYjoe.js"),__vite__mapDeps([5,1,2,3,4])).then(t=>({default:t.AdminPage}))),lt=()=>e.jsx("div",{className:"min-h-[60vh] flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"w-12 h-12 border-4 border-cyber-primary/20 border-t-cyber-primary rounded-full animate-spin mx-auto mb-4"}),e.jsx("p",{className:"text-[10px] font-black text-gray-500 uppercase tracking-[0.3em]",children:"Loading Intelligence..."})]})}),ct=()=>{const t=G();return l.useEffect(()=>{window.scrollTo(0,0);const i={"/":"Open Your AIs | Future Tech & Wealth Intelligence","/tools":"AI Tools Directory | Open Your AIs","/playbooks":"Monetization Playbooks | Open Your AIs","/crypto":"Crypto Intelligence | Open Your AIs","/blog":"Tech Intel Blog | Open Your AIs","/about":"About Us | Open Your AIs","/contact":"Contact Us | Open Your AIs","/privacy":"Privacy Policy | Open Your AIs","/terms":"Terms of Service | Open Your AIs","/sitemap":"Sitemap | Open Your AIs"};document.title=i[t.pathname]||"Open Your AIs | Future Tech & Wealth Intelligence",typeof window.gtag=="function"&&window.gtag("config","G-EBZ4F0ZXRY",{page_path:t.pathname+t.search,page_title:document.title})},[t]),null},dt=()=>e.jsx(Le,{children:e.jsxs(oe,{children:[e.jsx(ct,{}),e.jsx(Ge,{children:e.jsx(l.Suspense,{fallback:e.jsx(lt,{}),children:e.jsxs(ne,{children:[e.jsx(f,{path:"/",element:e.jsx(Qe,{})}),e.jsx(f,{path:"/tools",element:e.jsx(et,{})}),e.jsx(f,{path:"/playbooks",element:e.jsx(tt,{})}),e.jsx(f,{path:"/playbooks/:id",element:e.jsx(ot,{})}),e.jsx(f,{path:"/crypto",element:e.jsx(it,{})}),e.jsx(f,{path:"/crypto/:id",element:e.jsx(nt,{})}),e.jsx(f,{path:"/blog",element:e.jsx(at,{})}),e.jsx(f,{path:"/blog/:slug",element:e.jsx(st,{})}),e.jsx(f,{path:"/about",element:e.jsx(Z,{})}),e.jsx(f,{path:"/contact",element:e.jsx(ee,{})}),e.jsx(f,{path:"/privacy",element:e.jsx(R,{type:"privacy"})}),e.jsx(f,{path:"/terms",element:e.jsx(R,{type:"terms"})}),e.jsx(f,{path:"/sitemap",element:e.jsx(X,{})}),e.jsx(f,{path:"/admin",element:e.jsx(rt,{})}),e.jsx(f,{path:"*",element:e.jsx(j,{})})]})})})]})}),B=document.getElementById("root");B?(K(B).render(e.jsx(ie.StrictMode,{children:e.jsx(ae,{children:e.jsx(dt,{})})})),typeof window<"u"&&window.dispatchEvent(new Event("render-event"))):console.error("Critical Error: Root element not found.");export{O as A,m as C,J as P,A as S,yt as T,P as a,C as b,Ye as c,e as j,gt as s,De as u};
//# sourceMappingURL=index-DwkSnShv.js.map
